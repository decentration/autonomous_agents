...
memory_stream.add_memory(Observation(content='Alice just proposed a referendum #35 🗳️', timestamp=current_time - timedelta(minutes=60), importance=7))
memory_stream.add_memory(Observation(content='Alice just sent a transaction to Bob.', timestamp=current_time - timedelta(minutes=58), importance=5, ))
