...
class ProposalReviewScenario:
    ...
    def review_initial_proposal(self):
    ...
    def request_updates(self):
        ...
        # Note: You'd need to implement get_last_feedback or an appropriate method to fetch the feedback
    ...
    def review_updated_proposal(self):
...
scenario.review_initial_proposal()
scenario.request_updates()
